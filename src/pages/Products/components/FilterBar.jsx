  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`fixed z-40 h-screen p-5 overflow-y-auto bg-white w-72 dark:bg-gray-800 transition-transhtmlForm left-0 top-0 transhtmlForm-none backdrop-blur-sm bg-opacity-50 dark:bg-opacity-50  `}
        tabIndex="-1"
      ...
      >
        <h5
          ...
          className="text-2xl  text-gray-500 uppercase dark:text-gray-300"
        >
          Filters
        </h5>
        <button
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  id="rating-sort-1"
                  type="radio"
                  onChange={()=>dispatch({type:'RATINGS',payload:{rating:'4StarAbove'}})}
                  checked={state.rating === '4StarAbove'}
                  value=""
                  name="rating-sort"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
              ...
              <div className="flex items-center my-1">
                <input
                  id="rating-sort-2"
                  type="radio"
                  onChange={()=>dispatch({type:'RATINGS',payload:{rating:'3StarAbove'}})}
                  checked={state.rating === '3StarAbove'}
                  value=""
                  name="rating-sort"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
              ...
              <div className="flex items-center my-1">
                <input
                  id="rating-sort-3"
                  type="radio"
                  onChange={()=>dispatch({type:'RATINGS',payload:{rating:'2StarAbove'}})}
                  checked={state.rating === '2StarAbove'}
                  value=""
                  name="rating-sort"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
              ...
              <div className="flex items-center my-1">
                <input
                  id="rating-sort-4"
                  type="radio"
                  onChange={()=>dispatch({type:'RATINGS',payload:{rating:'1StarAbove'}})}
                  checked={state.rating === '1StarAbove'}
                  value=""
                  name="rating-sort"
                  className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 dark:bg-gray-700 dark:border-gray-600"
                />
            ...
            <li className="mt-1 mb-5">
              ...
              <div className="flex items-center my-1">
                <input
                  id="only-instock"
                  type="checkbox"
                  onChange={()=>dispatch({type:'IN_STOCK_ONLY',payload:{inStockOnly: !state.inStockOnly}})}
